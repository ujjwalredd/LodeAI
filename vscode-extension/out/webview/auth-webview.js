...
exports.getProgressWebviewContent = exports.getAuthWebviewContent = void 0;
function getAuthWebviewContent() {
    return `
	<!DOCTYPE html>
	<html lang="en">
	<head>
...
exports.getAuthWebviewContent = getAuthWebviewContent;
function getProgressWebviewContent() {
    return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
...
exports.getProgressWebviewContent = getProgressWebviewContent;
